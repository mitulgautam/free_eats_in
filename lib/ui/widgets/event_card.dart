...
class EventCard extends StatelessWidget {
  ...
  const EventCard({Key key, @required this.cost, @required this.index, this.cardType, this.helpType}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GestureDetector(
        onTap: () {
          Navigator.pushNamed(context, Strings.EVENT_DETAILS, arguments: <String, String>{
            'index': '$index',
            'banner':
                    ...
                    Expanded(
                        ...
                        child: Padding(
                            ...
                            child: SizedBox(
                              ...
                              Text("KH-001, Kavinagar, Ghaziabad, U.P. India 201001",
                                  maxLines: 2,
                                  style:
                                      GoogleFonts.quicksand(textStyle: Theme.of(context).textTheme.bodyText2.copyWith(fontFamily: Fonts.METROPOLIS_REGULAR))),
/*                      Row(
                              ...
                              helpType != null
                                  ? Padding(
                                      ...
                                      child: Row(mainAxisAlignment: MainAxisAlignment.start, children: <Widget>[
                                        Text("post by @MitulGautam", style: TextStyle(color: Themes.DARK_BROWN_COOKIE)),
                                        ClipRRect(
                  ...
                  cardType == CardType.HELP_SECTION
                      ? Text("Sample description for food help from ngo or any other society. This is done by some socirty",
...
class CostTypeChip extends StatefulWidget {
  ...
  const CostTypeChip({Key key, @required this.cost, this.helpType}) : super(key: key);
...
class _CostTypeChipState extends State<CostTypeChip> {
  ...
  Widget build(BuildContext context) {
    return Chip(
        label:
            Text(widget.cost == Cost.FREE ? widget.helpType == null ? "FREE" : widget.helpType : "PAID", style: TextStyle(color: Colors.white, fontSize: 12.0)),
